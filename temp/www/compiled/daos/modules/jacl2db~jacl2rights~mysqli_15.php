...
if (jApp::config()->compilation['checkCacheFiletime']&&(
 ...
 filemtime('G:\wamp\jelix\lib_1_6_10_dev/jelix-modules/jacl2db/daos/jacl2rights.dao.xml') > 1474525077)){ return false;
}
else {
 require_once ( JELIX_LIB_PATH .'dao/jDaoRecordBase.class.php');
 require_once ( JELIX_LIB_PATH .'dao/jDaoFactoryBase.class.php');

class cDaoRecord_jacl2db_Jx_jacl2rights_Jx_mysqli extends jDaoRecordBase {
 public $id_aclsbj;
 public $id_aclgrp;
 public $id_aclres;
 public $canceled;
   public function getSelector() { return "jacl2db~jacl2rights"; }
   public function getProperties() { return cDao_jacl2db_Jx_jacl2rights_Jx_mysqli::$_properties; }
   public function getPrimaryKeyNames() { return cDao_jacl2db_Jx_jacl2rights_Jx_mysqli::$_pkFields; }
}

class cDao_jacl2db_Jx_jacl2rights_Jx_mysqli extends jDaoFactoryBase {
  ...
  array (
   ...
   protected $_selectClause='SELECT `r`.`id_aclsbj`, `r`.`id_aclgrp`, `r`.`id_aclres`, `r`.`canceled`';
   protected $_fromClause;
   protected $_whereClause='';
   protected $_DaoRecordClassName='cDaoRecord_jacl2db_Jx_jacl2rights_Jx_mysqli';
