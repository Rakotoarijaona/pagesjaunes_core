...
if (jApp::config()->compilation['checkCacheFiletime']&&(
 ...
 filemtime('G:\wamp\jelix\lib_1_6_10_dev/jelix-modules/jacl2db/daos/jacl2usergroup.dao.xml') > 1480239166)){ return false;
}
else {
 require_once ( JELIX_LIB_PATH .'dao/jDaoRecordBase.class.php');
 require_once ( JELIX_LIB_PATH .'dao/jDaoFactoryBase.class.php');

class cDaoRecord_jacl2db_Jx_jacl2usergroup_Jx_mysqli extends jDaoRecordBase {
 public $login;
 public $id_aclgrp;
   public function getSelector() { return "jacl2db~jacl2usergroup"; }
   public function getProperties() { return cDao_jacl2db_Jx_jacl2usergroup_Jx_mysqli::$_properties; }
   public function getPrimaryKeyNames() { return cDao_jacl2db_Jx_jacl2usergroup_Jx_mysqli::$_pkFields; }
}

class cDao_jacl2db_Jx_jacl2usergroup_Jx_mysqli extends jDaoFactoryBase {
  ...
  array (
   ...
   protected $_selectClause='SELECT `ug`.`login`, `ug`.`id_aclgrp`';
   protected $_fromClause;
   protected $_whereClause='';
   protected $_DaoRecordClassName='cDaoRecord_jacl2db_Jx_jacl2usergroup_Jx_mysqli';
...
public function update ($record){
     throw new jException('jelix~dao.error.update.impossible',array('jacl2db~jacl2usergroup','G:\wamp\jelix\lib_1_6_10_dev/jelix-modules/jacl2db/daos/jacl2usergroup.dao.xml'));
 }
