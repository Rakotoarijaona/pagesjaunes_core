...
filemtime('G:\wamp\pagesjaunes_core/modules/ads/templates/ads_zone_update.tpl') > 1487089002){ return false;
} else {
 require_once('G:\wamp\jelix\lib_1_6_10_dev\jelix/plugins/tpl/html/function.jurl.php');
function template_meta_7a1c94e16c073392672396f261da40f3($t){

}
function template_7a1c94e16c073392672396f261da40f3($t){
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form id="adzoneform" role="form" action="<?php jtpl_function_html_jurl( $t,'ads~ads_zone:save_edit');?>" method="POST">
                        <input type="hidden" name="id" value="<?php echo $t->_vars['oAdsZone']->id; ?>">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group r-form">
                                    <label>Nom zone</label>
                                    <input type="text" id="zone_name" name="zone_name" class="form-control" value="<?php echo $t->_vars['oAdsZone']->name; ?>"/>
                                </div>
                                <div class="form-group r-form">
                                    <label>Coût estimatif modèle</label>
                                    <select class="form-control" name="cost_model" id="cost_model">
                                        <option value="jour" <?php if(($t->_vars['oAdsZone']->cost_model == 'jour')):?>selected<?php endif;?>>Coût journalier</option>
                                        <option value="clic" <?php if(($t->_vars['oAdsZone']->cost_model == 'clic')):?>selected<?php endif;?>>Coût par clic</option>
                                        <option value="impression" <?php if(($t->_vars['oAdsZone']->cost_model == 'impression')):?>selected<?php endif;?>>Coût par impression</option>
                                    </select>
                                </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div id="price_list">
                                            <table class="table table-bordered table-responsive">
                                                ...
                                                <tbody>
                                                    <?php foreach($t->_vars['oAdsZone']->getPriceList() as $t->_vars['rowPrice']):?>
                                                        <tr class="price olprice">
                                                            <input type="hidden" class="hdprice" name="price[]" value="<?php echo $t->_vars['rowPrice']->id; ?>"/>
                                                            <td><?php echo $t->_vars['rowPrice']->price; ?></td>
                                                            <td><?php echo $t->_vars['rowPrice']->number; ?></td>
                                                            <td><?php echo $t->_vars['rowPrice']->unity; ?></td>
                                ...
                                <div class="row">
                                    <div class="form-group r-form col-sm-6">
                                        <label>Largeur</label>
                                        <div class="input-group m-b">
                                            <input type="text" class="form-control" name="width" value="<?php echo $t->_vars['oAdsZone']->width; ?>"> <span class="input-group-addon">px</span>
                                        </div>
                                    </div>
                                    <div class="form-group r-form col-sm-6">
                                        <label>Hauteur</label>
                                        <div class="input-group m-b">
                                            <input type="text" class="form-control" name="height" value="<?php echo $t->_vars['oAdsZone']->height; ?>"> <span class="input-group-addon">px</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group r-form">
                                ...
                                <div class="row">
                                    <div class="form-group r-form col-sm-6">
                                        <label>Colonne</label>
                                        <input type="text" class="form-control" name="column" value="<?php echo $t->_vars['oAdsZone']->slots_columns; ?>">
                                    </div>
                                    <div class="form-group r-form col-sm-6">
                                        <label>Ligne</label>
                                        <input type="text" class="form-control" name="row" value="<?php echo $t->_vars['oAdsZone']->slots_row; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-horizontal">
                                            <div class="form-group r-form m-b">
                                                <div class="col-md-5">
                                                    <input type="text" class="form-control" name="number_rotation" value="<?php echo $t->_vars['oAdsZone']->number_rotation; ?>">
                                                </div>
                                                <div class="col-md-7">Nombre de rotation par slot, minimum 2 pubs par slot</div>
                                            </div>
                                            <div class="form-group r-form m-b">
                                                <div class="col-md-5">
                                                    <input type="text" class="form-control" name="number_client" value="<?php echo $t->_vars['oAdsZone']->number_client; ?>">
                                                </div>
                                            ...
                                            <div class="form-group r-form m-b">
                                                <div class="col-md-5">
                                                    <div class="input-group m-b">
                                                        <input type="text" class="form-control" name="line_height" value="<?php echo $t->_vars['oAdsZone']->line_height; ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="radio radio-info radio-inline">
                                                    <input type="radio" id="radiopublie1" value="1" name="is_publie" <?php if(($t->_vars['oAdsZone']->is_publie == 1)):?>checked<?php endif;?>>
                                                    <label for="radiopublie1"> oui </label>
                                                </div>
                                                <div class="radio radio-info radio-inline">
                                                    <input type="radio" id="radiopublie2"  value="0" name="is_publie" <?php if(($t->_vars['oAdsZone']->is_publie == 0)):?>checked<?php endif;?>>
