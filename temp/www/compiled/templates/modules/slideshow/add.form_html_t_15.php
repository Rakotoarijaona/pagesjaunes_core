...
filemtime('G:\wamp\pagesjaunes_core/modules/slideshow/templates/add.form.tpl') > 1486016626){ return false;
} else {
 require_once('G:\wamp\jelix\lib_1_6_10_dev\jelix/plugins/tpl/html/function.jurl.php');
function template_meta_d6c0894c12b8dae49c1551fa95c98bf2($t){

}
function template_d6c0894c12b8dae49c1551fa95c98bf2($t){
?><div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="<?php jtpl_function_html_jurl( $t,'slideshow~slideshow:index');?>">Slideshow</a>
            </li>
            <li class="active">
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form role="form" id="form" enctype="multipart/form-data" action="<?php jtpl_function_html_jurl( $t,'slideshow~slideshow:save_add');?>" method="POST">
                        <div class="row">
                                ...
                                <div class="form-group r-form">
                                    ...
                                    <div class="input-group">
                                        <select data-placeholder="Selectionnez une entreprise" style="width:250px" name="entrepriseId" id="entrepriseId" class="chosen-select" tabindex="6">
                                            ...
                                            <?php foreach($t->_vars['toEntreprise'] as $t->_vars['rowEntreprise']):?>
                                            <option value="<?php echo $t->_vars['rowEntreprise']->id; ?>"><?php echo $t->_vars['rowEntreprise']->raisonsociale; ?></option>
                                            <?php endforeach;?>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-12 text-left">
                            ...
                            <a href="<?php jtpl_function_html_jurl( $t,'slideshow~slideshow:index');?>"><button type="button" class="btn btn-white" data-dismiss="modal">Annuler</button></a>
                        </div>
                    </form>
                </div>
            </div>
...
$(document).ready(function(){
    ...
    rules: {
        slidename: {
            ...
            minlength: 3,
            remote: {
                url: "<?php jtpl_function_html_jurl( $t,'slideshow~slideshow:insertNameExist');?>",
                type: "post",
                data: {
                    name: function () {
    ...
    $('.btn-submit').click(function(){
        ...
        if ($('#form').valid())
        {
            //alert (insertNameExist('<?php jtpl_function_html_jurl( $t,"slideshow~slideshow:insertNameExist");?>', $('#slidename').val()));
            $('#form').submit();
        } 
    });
