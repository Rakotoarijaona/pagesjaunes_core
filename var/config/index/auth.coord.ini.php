...
on_error_action="front_office~default:index"

; action to execute when a bad ip is checked with secure_with_ip=1 and on_error=2
bad_ip_action="front_office~default:index"
...
after_login="front_office~default:fiche_details"

; action to redirect after a logout
after_logout="pagesjaunes_core~pagesjaunes:index"
...
form="pagesjaunes_core~loginForm"
