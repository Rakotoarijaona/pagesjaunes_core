                        ...
                        <table width="600" border="0" cellpadding="0" cellspacing="0" bgcolor="#DAE9C8">
                            <tr>
                                ...
                                bgcolor="#ffffff" style="font-family:arial;color:#000000;padding:0px 10px 10px 10px;">
                                    Merci de nous avoir contacté. Un de nos commerciaux va vous contacter au numéro de téléphone reçu {$phone} dans 24h. Pagesjaunes.mg vous remercie de votre confiance. Pour rappel, voici le contenu de votre message.
                                </td>
                            </tr>
                        </table>
                        <table width="600" border="0" cellpadding="0" cellspacing="0" bgcolor="#DAE9C8">
