        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form id="adsform" role="form" action="{jurl 'ads~ads:save_delete'}" method="POST">
                        <input type="hidden" name="id" value="{$oAds->id}"/>
                        <div class="form-group r-form">
                            <label>Êtes-vous sure de vouloir supprimer la publicité "{$oAds->name}"?</label>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 text-left">
                              ...
                              <a href="{jurl 'ads~ads:list'}" class="btn btn-white" id="cancel">Annuler</a>
                            </div>
                        </div>
                    </form>
                </div>
