        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form id="adsform" role="form" action="{jurl 'ads~ads:save_config'}" method="POST">
                        <div class="form-group r-form">
                            <label>Nom *</label>
                            <div>
                                <input type="text" id="adstypename" name="adstypename" class="form-control" style="max-width:350px;" />
                            </div>
                        </div>
                        <div class="form-group r-form">
                            <label>Format *</label>
                            <div>
                                <input type="text" id="adstypeformatwidth" name="adstypeformatwidth" class="form-control" style="max-width:100px;display:inline-block;" />&nbsp; x &nbsp;<input type="text" id="adstypeformatheight" name="adstypeformatheight" class="form-control" style="max-width:100px;display:inline-block;" />&nbsp; <strong>pixels</strong>
                            </div>
                        </div>
                        <div class="form-group r-form">
                            <label class="control-label">Types de fichiers *</label> 
                            <textarea id="typefichier" name="typefichier" class="form-control" style="max-width:350px;"></textarea>
    ...
    $('#adsform').validate({        
        rules: {
            adstypename: {
                required: true,
                remote: {
                    url: "{/literal}{jurl 'ads~ads:insertAdsTypeNameExist'}{literal}",
                    type: "post",
                    data: {
                        name: function () {
