<input type="hidden" name="catalogueId" id="catalogueId" value="{$oCatalogue->id}"/>
<div class="form-group">
    <label>Référence produit *</label>
    <input id="refProduit" name="refProduit" type="text" class="form-control" value="{$oCatalogue->reference_produit}">
</div>
<div class="form-group">
    <label>Nom produit *</label>
    <input id="nomProduit" name="nomProduit" type="text" class="form-control" value="{$oCatalogue->nom_produit}">
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <textarea id="descProduit" name="descProduit" class="form-control">{$oCatalogue->description_produit}</textarea>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="input-group">
        <input id="prixProduit" name="prixProduit" type="text" class="form-control" value="{$oCatalogue->prix_produit}">
...
<div class="form-group">
    ...
    <div class="input-group">
        <div class="radio radio-info radio-inline">
            <input type="radio" id="radioCatalogueIsPublie1" value="1" name="radioCatalogueIsPublie" {if ($oCatalogue->is_publie == '1')}checked{/if} >
            <label for="radioCatalogueIsPublie1"> oui </label>
        </div>
        <div class="radio radio-info radio-inline">
            <input type="radio" id="radioCatalogueIsPublie2" value="0" name="radioCatalogueIsPublie" {if ($oCatalogue->is_publie == '0')}checked{/if} >
