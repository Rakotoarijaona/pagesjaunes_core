                    ...
                    <div class="ibox-content">
                        ...
                        <div class="row">
                            <div class="col-lg-12 text-right">
                                <a href="{jurl 'entreprise~entreprise:sentNotificationEmail', array('email' => 'rakotoarijohn@gmail.com')}" class="btn btn-info">{@entreprise~entreprise.notifier.le.client@}</a> 
