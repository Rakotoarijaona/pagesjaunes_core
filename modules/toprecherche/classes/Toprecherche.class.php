...
class Toprecherche
{
    ...
    {
        $oSc = Souscategorie::getById($this->souscategorie_id);
        $title = $oSc ->name;
        return $title;
    }
    public function getTop1()
    {
        $oEntreprise = Entreprise::getById($this->entreprise_id_top1);
        return $oEntreprise;
    }
    public function getTop2()
    {
        $oEntreprise = Entreprise::getById($this->entreprise_id_top2);
        return $oEntreprise;
    }
    public function getTop3()
    {
        $oEntreprise = Entreprise::getById($this->entreprise_id_top3);
        return $oEntreprise;
    }
    ...
    {
        $oEntreprise1 = Entreprise::getByid($this->entreprise_id_top1);
        $oEntreprise2 = Entreprise::getByid($this->entreprise_id_top2);
        $oEntreprise3 = Entreprise::getByid($this->entreprise_id_top3);
