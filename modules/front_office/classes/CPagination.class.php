...
class CPagination
{
	public static function paginate($url, $total, $current, $adj=1)
	{
		...
		if ($total > 1) {
			...
			if ($current == 2) {
				...
				$pagination .= "<li><a href=\"{$url}\"><span aria-hidden=\"true\"><i class=\"fa fa-angle-left\"></i></span></a></li>";
			} elseif ($current > 2) {
				// la page courante est supérieure à 2, le bouton renvoie sur la page dont le numéro est immédiatement inférieur
				$pagination .= "<li><a href=\"{$url}&page={$prev}\"><span aria-hidden=\"true\"><i class=\"fa fa-angle-left\"></i></span></a></li>";
			} else {
				// dans tous les autres, cas la page est 1 : désactivation du bouton [précédent]
				$pagination .= "<li><a href=\"#\"><span aria-hidden=\"true\"><i class=\"fa fa-angle-left\"></i></span></a></li>";
			}
			 ...
			 * ========================================= */
				...
				if ($current < 2 + ($adj * 2)) {
					...
					$pagination .= ($current == 1) ? '<li class="active"><a href="#">1</a></li>' : "<li class=\"active\"><a href=\"{$url}\">1</a></li>";
					...
					$pagination .= "<li><a href=\"{$url}&page={$penultimate}\">{$penultimate}</a></li>";
					$pagination .= "<li><a href=\"{$url}&page={$total}\">{$total}</a></li>";
				}
				/**
			 ...
			 * =============================== */
			if ($current == $total)
				$pagination .= "<li><a href=\"#\"><span aria-hidden=\"true\"><i class=\"fa fa fa-angle-right\"></i></span></a></li>\n";
			else
				$pagination .= "<li><a href=\"{$url}&page={$next}\"><i class=\"fa fa fa-angle-right\"></i></a></li>\n";
