...
<main>
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="active"><strong>{$nbRecs} résultat(s) trouvé(s)</strong></li>
        </ol>
        ...
        <div class="filter-wrapper">
            <div class="btn-group layout-result hidden-xs" data-toggle="buttons">
                ...
                <label class="btn btn-primary">
                    <input type="radio" name="layout-option" id="layout-list" autocomplete="off" value="1"><i class="fa fa-th-list"></i>
                </label>
                <label class="btn btn-primary active">
                    <input type="radio" name="layout-option" id="layout-thumb" autocomplete="off" checked value="0"><i class="fa fa-th-large"></i>
                </label>
            </div>
        </div>
        {/if}
                        ...
                        <li>
                            <div class="result-item">
                                ...
                                <div class="infos">
                                    ...
                                    <p class="desc ellipsis">{$oEntreprise->activite}</p>
                                ...
                                <a href="{jurl 'front_office~default:fiche_details', array('entreprise' => $oEntreprise->id)}" class="btn btn-default">+ détail</a>
                            </div>
                        </li>
                        {/foreach}
                    </ul>
