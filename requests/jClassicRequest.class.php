...
class jClassicRequest extends jRequest
{
    ...
    protected function _initParams ()
    {
        ...
        $oCoord = jApp::coord();
        $zModule                    = $oCoord->request->getParam ('module');
        $zAction                    = $oCoord->request->getParam ('action');
        $zModuleAction = $oCoord->request->getParam ('module') . "~" . $oCoord->request->getParam ('action');
    }
